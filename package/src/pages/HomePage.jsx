      ...
      <Card variant="outlined" sx={{ p: 0, mb: 3 }}>
        <CardContent>
          ...
          <Typography variant="body1" gutterBottom>
            A platform to share and manage notes and documents easily among students, lecturers, and admins.
          </Typography>
        </CardContent>
      </Card>
        ...
        <Grid item xs={12} sm={6} md={4}>
          <Card variant="outlined" sx={{ p: 2 }}>
            <CardContent>
              ...
              <Typography variant="body2" gutterBottom>
                Manage users, review submissions, and oversee the entire system.
              </Typography>
